...
export default class MainScreen extends Component {
  constructor(props) {
    ...
    this.state = { //You use inside the render, vars, and functions, but never for other states inside this body
      ...
      calculatedValues: [[]],
      highscore: ["Score1", "Score2", "Score3", "Score4", "Score5", "Score6", "Score7", "Score8"],
      widthArr: [160, 215],
  ...
  calculateValues(grade) {
    ...
    if (grade == "10-10-10") {
      if (this.state.gradeTenChecked) {
        ...
        this.state.nValues1 = [this.state.nlabel1, this.state.nResult.toFixed(2), this.state.nResult.toFixed(2), this.state.nResult.toFixed(2), changeMyColorPlease(NSD1), changeMyColorPlease(PSD1), changeMyColorPlease(KSD1), this.state.score1];
        ...
        this.state.pValues1 = [this.state.pLabel1, this.state.pResult.toFixed(2), this.state.pResult.toFixed(2), this.state.pResult.toFixed(2), changeMyColorPlease(NSD2), changeMyColorPlease(PSD2), changeMyColorPlease(KSD2), this.state.score2];
        ...
        this.state.kValues1 = [this.state.kLabel1, this.state.kResult.toFixed(2), this.state.kResult.toFixed(2), this.state.kResult.toFixed(2), changeMyColorPlease(NSD3), changeMyColorPlease(PSD3), changeMyColorPlease(KSD3), this.state.score3 - 1];   
    ...
    if (grade == "5-5-5") {
      if (this.state.gradeFiveChecked) {
        ...
        this.state.nValues2 = [this.state.nlabel2, this.state.nResult.toFixed(2), this.state.nResult.toFixed(2), this.state.nResult.toFixed(2), changeMyColorPlease(NSD1), changeMyColorPlease(PSD1), changeMyColorPlease(KSD1), this.state.score1];
        ...
        this.state.pValues2 = [this.state.pLabel2, this.state.pResult.toFixed(2), this.state.pResult.toFixed(2), this.state.pResult.toFixed(2), changeMyColorPlease(NSD2), changeMyColorPlease(PSD2), changeMyColorPlease(KSD2), this.state.score2];
        ...
        this.state.kValues2 = [this.state.kLabel2, this.state.kResult.toFixed(2), this.state.kResult.toFixed(2), this.state.kResult.toFixed(2), changeMyColorPlease(NSD3), changeMyColorPlease(PSD3), changeMyColorPlease(KSD3), this.state.score3 - 1];
    ...
    if (grade == "0-10-10") {
      if (this.state.gradeZeroTenChecked) {
        ...
        this.state.pValues3 = [this.state.pLabel3, zero.toFixed(2), this.state.pResult.toFixed(2), this.state.pResult.toFixed(2), changeMyColorPlease(NSD2), changeMyColorPlease(PSD2), changeMyColorPlease(KSD2), this.state.score2];
        ...
        this.state.kValues3 = [this.state.kLabel3, zero.toFixed(2), this.state.kResult.toFixed(2), this.state.kResult.toFixed(2), changeMyColorPlease(NSD3), changeMyColorPlease(PSD3), changeMyColorPlease(KSD3), this.state.score3 - 1];
    ...
    if (grade == "15-0-15") {
      ...
      if (this.state.gradeFifteenChecked) { //when check is true
        ...
        this.state.nValues4 = [this.state.nlabel4, this.state.nResult.toFixed(2), zero.toFixed(2), this.state.nResult.toFixed(2), changeMyColorPlease(NSD1), changeMyColorPlease(PSD1), changeMyColorPlease(KSD1), this.state.score1];
        ...
        this.state.kValues4 = [this.state.kLabel4, this.state.kResult.toFixed(2), zero.toFixed(2), this.state.kResult.toFixed(2), changeMyColorPlease(NSD3), changeMyColorPlease(PSD3), changeMyColorPlease(KSD3), this.state.score3 - 1];
    ...
    return (
      <Container>
        ...
        <TextInput
          ...
          <ListItem>
            <CheckBox checked={state.gradeTenChecked} onPress={() => {this.parseSelectedGrade("10-10-10"), this.checkGradeTen()}} />
            <Body>
              <Text> 10 - 10 - 10</Text>
            </Body>
          ...
          <View>
            <Table>
              ...
              <Rows data={state.gradeData} style={styles.head} textStyle={styles.text} />
              <TableWrapper>
